...
const Header = ({ search, setSearch, handleClick, handleEnter }) => {
  ...
  return (
    <div className="bg-gradient-to-r from-emerald-800 from-10% via-emerald-700 via-40% to-emerald-900 to-90% flex items-center py-5 font-cormorant sticky top-0 z-10 w-full">
