      ...
      const array = [
        {
          ...
          user: {
            ...
            links: {
              ...
              portfolio:
                "https://api.unsplash.com/users/sonika_agarwal/portfolio",
              following:
                "https://api.unsplash.com/users/sonika_agarwal/following",
              followers:
                "https://api.unsplash.com/users/sonika_agarwal/followers",
            },
            profile_image: {
              small:
        ...
        },
        {
          ...
          alt_description:
            "a couple of people walking down a rain soaked street",
          breadcrumbs: [],
          urls: {
